...
class App extends Component {
  ...
  gotoNextandStoreResult = e => {
    ...
    this.setState({
      quiz_responses: [...this.state.quiz_responses, e.target.id]
    });
        ...
        <div className="container">
          ...
          <div>
            <div className="blurb">
              ...
              <p>
                You find yourself standing amidst a great hall. The candles
                twinkle in the distance, and a thick silence lays over the
                atmosphere like a woolen blanket smothering the air.
              </p>
            </div>
            {this.state.show_quiz ? (
              <div />
            ) : (
              <button id="approach" onClick={this.quizStart}>
                Approach the Sorting Hat
              </button>
            )}
            {this.state.show_quiz ? (
              <Quiz
                question={this.state.curr_question}
                next={this.gotoNextandStoreResult}
            ...
            {this.state.show_result ? (
              <Results choices={this.state.quiz_result} />
            ) : (
              <div></div>
            )}
          </div>
